...
void main() {
  ...
  group('WorkerMessages', () {
    ...
    test('ApplyTemplateRequest', () {
      final req = ApplyTemplateRequest(1, [], true, sp);
      expect(req.messages, isEmpty);
      expect(req.addAssistant, true);
    });
    ...
    test('Responses', () {
      ...
      expect(ApplyTemplateResponse('p', ['s']).prompt, 'p');
      ...
      expect(LogResponse('l', 1).message, 'l');
      expect(WorkerHandshake(sp).logPort, sp);
