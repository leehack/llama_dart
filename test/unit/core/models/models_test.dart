...
void main() {
  group('ModelParams', () {
    test('default values', () {
      ...
      expect(params.contextSize, 4096); // Default updated to 4096
      expect(params.gpuLayers, 999);
  ...
  group('LlamaChatMessage', () {
    ...
    test('fromText constructor', () {
      const msg = LlamaChatMessage.fromText(
    ...
    test('withContent constructor and content concatenation', () {
    ...
    test('LlamaToolResultContent with non-encodable result', () {
      ...
      final msg = LlamaChatMessage.withContent(
        ...
        content: [LlamaToolResultContent(name: 'fail', result: circular)],
      );
